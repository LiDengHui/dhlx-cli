...
program.command('init <type>').description('Copy a specific configuration file (prettier or tsconfig) from the project to the current working directory').action(copyConfigFile);
